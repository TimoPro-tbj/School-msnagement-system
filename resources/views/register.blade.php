...
<form action="/register" method="POST" class="form" autocomplete="on" enctype="multipart/form-data">
    @csrf
  ...
  <legend class="h1">Register your institution</legend>

  <label class="label">School Name</label>
  <input type="text" name="schoolname" class="input" placeholder="Schoolname..." required />

  <label class="label">School Code</label>
  <input type="password" name="schoolcode"  class="input" placeholder="Schoolcode" required />

                <label class="label" for="images">Upload Badge</label>
                <input type="file" id="img" class="input" name="badge_path"  accept="image/*">
     <button type="submit" class="btn-neutral">Sign Up</button>
   @if ($errors->any())
