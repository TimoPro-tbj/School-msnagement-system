    ...
    <div class="table-responsive">
        <table class="custom-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <img src="{{ asset('storage/' .$student->image_path ) }}" class="image">
                    </td>
                    <td>
                    ...
                    <td>
                        <span class="course-tag">{{ $student->course ?? 'Unassigned' }}</span>
                    </td>
                    <td>
                        <span class="date-text">{{ $student->created_at  ?? 'No Date' }}</span>
                    </td>
                    <td class="text-right">
                        <a href="/{{ $student->id }}/student/edit" class="action-btn edit-btn">
