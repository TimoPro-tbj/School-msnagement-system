            ...
            <div class="form-grid">
                <div class="input-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="created_at" value="{{ old('created_at', $course->created_at )}}" required>
                    </div>
                    <div class="form-group">
                        <label>Assigned Teacher</label>
                        <input type="text" name="teacher_name" value="{{ old('course', $course->teacher_name) }}" required>
                    </div>
